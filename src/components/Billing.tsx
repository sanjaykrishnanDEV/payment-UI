...
export default function Billing({plan}) {
  return (
    <Card className='max-w-sm'>
      ...
      <a href="https://beamer-test.chargebee.com/hosted_pages/checkout?subscription_items[item_price_id][0]=nps_scale-USD-Monthly&subscription_items[quantity][0]=1&layout=full_page">
